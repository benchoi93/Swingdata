...
For road infrastructure association, we extracted OpenStreetMap (OSM) road networks for all 50 cities using \texttt{osmnx} \citep{boeing2017osmnx} and assigned each trip's start point to the nearest road edge via a KD-tree spatial index. This yields per-trip road class features enabling infrastructure-controlled analyses.
