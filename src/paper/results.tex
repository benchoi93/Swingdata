...
\multicolumn{5}{l}{\footnotesize HRs should be interpreted as average effects over the trip sequence (see Section~\ref{sec:disc_limitations}).} \\
\end{tabular}
\end{table}
